...
> [!NOTE]
> **Open source ArchiveBox does not support setting up *non-admin* users** with specific read/write permissions. We do offer this feature and more to [paying clients](https://docs.monadical.com/s/archivebox-consulting-services).
