...
> [!NOTE]
> **Open source ArchiveBox does not support setting up *non-admin* users** with individual read/write permissions. We do offer this feature and more to [paying clients](https://docs.monadical.com/s/archivebox-consulting-services).
