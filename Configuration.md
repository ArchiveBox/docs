...
<p align="center">
<i>In case this document is ever out of date, it's recommended to read the code that loads the config directly: <pre><a href="https://github.com/ArchiveBox/ArchiveBox/blob/master/archivebox/config.py#L27"><code>archivebox/config.py</code></pre></a> ➡️</i>
</p>
