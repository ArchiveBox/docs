...
````{py:function} log_cli_command(subcommand: str, subcommand_args: typing.Iterable[str] = (), stdin: str | typing.IO | None = None, pwd: str = '.')
...
````{py:function} log_snapshot_archiving_started(snapshot: archivebox.core.models.Snapshot, out_dir: str, is_new: bool)
...
````{py:function} log_snapshot_archiving_finished(snapshot: archivebox.core.models.Snapshot, out_dir: str, is_new: bool, stats: dict, start_ts: datetime.datetime)
...
````{py:function} log_archive_method_finished(result: dict)
...
````{py:function} log_removal_started(snapshots, yes: bool, delete: bool)
...
````{py:function} log_index_started(url: str)
...
````{py:function} log_worker_event(worker_type: str, event: str, indent_level: int = 0, pid: typing.Optional[int] = None, worker_id: typing.Optional[str] = None, url: typing.Optional[str] = None, plugin: typing.Optional[str] = None, metadata: typing.Optional[typing.Dict[str, typing.Any]] = None, error: typing.Optional[Exception] = None) -> None
...
````{py:function} printable_folders(folders: typing.Dict[str, typing.Optional[archivebox.core.models.Snapshot]], with_headers: bool = False) -> str
